...
const Footer = () => {
  ...
  return (
    <div
      ref={footerRef}
      className="mt-10 grid grid-cols-1 gap-6 justify-center sm:gap-4 py-[2rem]"
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 mx-10 justify-items-start border-b-2 border-b-gray-300 py-4">
